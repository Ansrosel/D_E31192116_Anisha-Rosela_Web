...
class Admin extends CI_Controller
{
	...
	function kategori_produk()
	{
		...
		$data['title'] = 'Kategori Produk - Toko Izah';
	...
	function tambah_kategori_produk()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Kategori Produk - Toko Izah';
	...
	function edit_kategori_produk()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Ubah Produk - Toko Izah';
	...
	function tambah_produk()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Produk - Toko Izah';
			$data['record'] = $this->model_app->view_ordering('tb_toko_kategoriproduk', 'id_kategori_produk', 'DESC');
	...
	function tambah_rekening()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Rekening - Toko Izah';
	...
	function edit_rekening()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Rekening - Toko Izah';
	...
	function tambah_supplier()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Supplier - Toko Izah';
	...
	function edit_supplier()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Supplier - Toko Izah';
	...
	function edit_konsumen()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Ubah Konsumen - Toko Izah';
	...
	function detail_konsumen()
	{
		...
		$data['title'] = 'Detail Konsumen - Toko Izah';
	...
	function pesanan_dikirim()
	{
		...
		$data['title'] = 'Masukan Resi - Toko Izah';
	...
	function website()
	{
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Identitas Website - Toko Izah';
	...
	function menu()
	{
		...
		$data['title'] = 'Menu Website - Toko Izah';
	...
	function tambah_menu()
	{
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Menu Website - Toko Izah';
	...
	function edit_menu()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Ubah Menu Website - Toko Izah';
			$data['record'] = $this->model_menu->menu_utama();
	...
	function logo()
	{
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Logo Website - Toko Izah';
	...
	function tambah_slider()
	{
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Slider - Toko Izah';
	...
	function edit_slider()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Slider -Toko Izah';
	...
	function tambah_halaman()
	{
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Halaman Baru -Toko Izah';
	...
	function edit_halaman()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Ubah Halaman Baru -Toko Izah';
	...
	function tambah_artikel()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Artikel -Toko Izah';
	...
	function edit_artikel()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Artikel -Toko Izah';
			$data['tag'] = $this->model_artikel->tag_artikel();
			$data['record'] = $this->model_artikel->kategori_artikel();
	...
	function tambah_tag_artikel()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Tag -Toko Izah';
	...
	function edit_user()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Pengguna -Toko Izah';
	...
	function users()
	{
		$data['title'] = 'Manajemen Pengguna -Toko Izah';
	...
	function tambah_user()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Pengguna -Toko Izah';
	...
	function laporan()
	{
		$data['title'] = 'Laporan Penjualan -Toko Izah';
	...
	function newsletter()
	{
		...
		$data['title'] = 'Newsletter -Toko Izah';
	...
	function tambah_newsletter()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Kirim News Letter -Toko Izah';
	...
	function lihat_newsletter()
	{
		...
		$data['title'] = 'Detail Berita -Toko Izah';
	...
	function subscriber()
	{
		$data['title'] = 'Subscriber -Toko Izah';
